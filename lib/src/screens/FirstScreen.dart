          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/welcome_images/p2.png'), // استبدل 'background_image.jpg' بمسار صورتك
                fit: BoxFit.cover,
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    ' وجه كاميرا الهاتف لتستطيع التعرف علي المعلم السياحي المحيط بك ',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 25,
                      fontWeight: FontWeight.bold,
